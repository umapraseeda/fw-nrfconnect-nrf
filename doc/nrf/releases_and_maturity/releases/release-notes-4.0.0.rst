.. _ncs_release_notes_400:

|NCS| v4.0.0 Release Notes
##########################
...
Sign up for the `nRF Connect SDK v4.0.0 webinar`_ to learn more about the new features.

Release tag
***********

The release tag for the |NCS| manifest repository (|ncs_repo|) is **v4.0.0**.
Check the :file:`west.yml` file for the corresponding tags in the project repositories.

To use this release, check out the tag in the manifest repository and run ``west update``.
See :ref:`cloning_the_repositories` and :ref:`gs_updating_repos_examples` for more information.

For information on the included repositories and revisions, see `Repositories and revisions for v4.0.0`_.
...
* `Twister test report for nRF Connect SDK v4.0.0`_
* `Hardware test report for nRF Connect SDK v4.0.0`_

IDE and tool support
********************

`nRF Connect extension for Visual Studio Code <nRF Connect for Visual Studio Code_>`_ is the recommended IDE for |NCS| v4.0.0.
...
.. list-table:: Modem-related libraries and versions
   ...
   * - Library name
     - Version information
   * - Modem library
     - `Changelog <Modem library changelog for v4.0.0_>`_
   * - LwM2M carrier library
     - `Changelog <LwM2M carrier library changelog for v4.0.0_>`_

Migration notes
***************

See the `Migration guide for nRF Connect SDK v4.0.0`_ for the changes required or recommended when migrating your application from |NCS| v3.9.0 to |NCS| v4.0.0.

Known issues
************

Known issues are only tracked for the latest official release.
See `known issues for nRF Connect SDK v4.0.0`_ for the list of issues valid for the latest release.

.. _ncs_release_notes_400_changelog:
