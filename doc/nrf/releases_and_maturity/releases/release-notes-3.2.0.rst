...
This patch release adds the following changes on top of the :
#TODO

Sign up for the `nRF Connect SDK v3.2.0 webinar`_ to learn more about the new features.
...
The MCUboot fork in |NCS| (``sdk-mcuboot``) contains all commits from the upstream MCUboot repository up to and including ``12315483fcbdf1f1524c2b34a1fd4de6c77cd0f4``, with some |NCS| specific additions.
...
The Zephyr fork in |NCS| (``sdk-zephyr``) contains all commits from the upstream Zephyr repository up to and including ``12359bf1e4b96122c3467295b09a034e399c5ee6``, with some |NCS| specific additions.
