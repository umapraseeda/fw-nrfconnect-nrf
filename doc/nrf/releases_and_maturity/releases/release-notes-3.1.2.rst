...
Sign up for the `nRF Connect SDK v3.1.2 webinar`_ to learn more about the new features.
...
* `Twister test report for nRF Connect SDK v3.1.2`_
* `Hardware test report for nRF Connect SDK v3.1.2`_
...
See the `Migration guide for nRF Connect SDK v3.1.2`_ for the changes required or recommended when migrating your application from |NCS| v3.0.2 to |NCS| v3.1.2.
