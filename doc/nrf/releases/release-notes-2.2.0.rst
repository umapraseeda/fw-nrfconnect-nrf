...
* Improved:
  ...
  * Power Envelope Control with hardware including nRF21540 to flatten the output power over temperature and frequency.
...
* Added the functionality where Radio trim values are reapplied after a ``POWER`` register write as a workaround for the hardware Errata 158 of the nRF5340 chip.
